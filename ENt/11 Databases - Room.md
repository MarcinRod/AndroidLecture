...
Following good architecture practices (described in detail in [Application Architecture](ENt/10%20Application%20Architecture.md) chapter), ViewModel shouldn't access DAO directly. Introduce **repository** – intermediary layer hiding database access details.
...
### **Next topic:** [Internet Communication - Retrofit](ENt/12%20Internet%20Communication%20-%20Retrofit.md)
