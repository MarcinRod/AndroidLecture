...
In more elaborate screens recommend storing screen state as sealed class object. Allows clearly describing different possible UI states (e.g., loading, success, error) and eases management. Example below uses `viewModelScope` – coroutine scope tied to ViewModel lifecycle, automatically cancelled on its destruction (more in [Background Tasks - Coroutines](ENt/09%20Background%20Tasks%20-%20Coroutines.md) chapter).
...
### **Next topic:** [Databases - Room](ENt/11%20Databases%20-%20Room.md)
